                            ...
                            <v-card class="border-radius-5">
                                <v-card-text>
                                    ...
                                    <v-layout align-start justify-start row>
                                        ...
                                        <v-layout align-start justify-start row>
                                            <label class="font-14">Recieved= {{recievable.recieved}}({{Math.round(((recievable.recieved*100)/recievable.total))}}%)</label>                                        
                                        </v-layout>
                                </v-card-text>
                            </v-card>
                        </v-flex>
                            ...
                            <v-card class="border-radius-5">
                                <v-card-text>
                                    ...
                                    <v-layout align-start justify-start row>
                                        ...
                                        <v-layout align-start justify-start row>
                                            <label class="font-14">Paid= {{payable.paid}}({{Math.round(((payable.paid*100)/payable.total))}}%)</label>                                        
                                        </v-layout>
                                </v-card-text>
                            </v-card>
                        </v-flex>
