              ...
              <v-container grid-list-xs v-if="showBulk==true">
                <v-layout align-center justify-start row wrap>
                  ...
                  <v-flex xs7 sm3>
                    ...
                    <a :href="url+'/'+$route.params.username+'/api/fileUploads/SampleFiles/download/AddSupplier.xlsx?access_token='+this.$store.state.token" download ref="sampleFile"> </a>
                  </v-flex>
                </v-layout>
                ...
                <v-layout row wrap class="mb-3">
                                    <v-flex sm12 class="font-14">a) Supplier name , b) Mobile No , c) Email , d) Street , e) Area , f) Pincode , g) City , h) State , i) Gstn , j) StateCode</v-flex>
                </v-layout> 
                <v-layout row wrap class="mb-3">
