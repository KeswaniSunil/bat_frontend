  ...
  <v-layout>
    <v-flex xs12 sm12>
      <v-card class="border-radius-5">
        <v-card-text>
          <v-layout align-center justify-space-between :class="[$store.state.biggerScreen ? 'row' : 'column']" wrap>
            <div>
                ...
                <v-container grid-list-xs v-if="showBulk==true">
                  <v-layout align-center justify-start row wrap>
                    ...
                    <v-flex xs7 sm3>
                      ...
                      <a :href="url+'/'+$route.params.username+'/api/fileUploads/SampleFiles/download/AddCustomer.xlsx?access_token='+this.$store.state.token"
