                        ...
                        <v-card>
                            ...
                            <v-container grid-list-xs v-if="showBulk==true">
                                ...
                                <v-flex xs7 sm3>
                                    ...
                                    <a :href="url+'/'+$route.params.username+'/api/fileUploads/SampleFiles/download/AddItems.xlsx?access_token='+this.$store.state.token" download ref="sampleFile"> </a>
                                </v-flex>
                                </v-layout>
                                ...
                                <v-layout row wrap class="mb-3">
                                                    <v-flex sm12 class="font-14">a) Item name , b) Bill Name , c) Price , d) Type , e) SubType , f) Unit , g) Hsn Code , h) Bar Code</v-flex>
                                </v-layout> 
                                <v-layout row wrap class="mb-3">
                                                    <v-flex sm12 class="font-18">[<b>Note</b>:- Item Name, Bill Name , Price , Type , SubType , Unit are compulsory Fields]</v-flex>
                                </v-layout>
                                <v-layout row wrap>
                                                <v-flex sm12>
                                                    <!-- begin panel -->
