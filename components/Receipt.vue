<template>
  <div id="section-to-print" style="width:100%;color:black;padding-top:10px;">  
      <table border="1" width="100%" cellspacing="0" style="">
        ...
        <!-- row1 -->
          <td colspan="2">
            ...
            <br />
            <b>Address: </b>{{companyDetails.address}}, {{companyDetails.city}}, {{companyDetails.state}} {{companyDetails.pinCode}}<br />
        ...
        <!-- row7 -->
          <td rowspan="4">
            ...
            Address: {{customer.area}}, {{customer.street}}, {{customer.city}}, {{customer.state}} {{customer.pincode}}<br />
          ...
          <td rowspan="4">
            ...
            Date Of Issue: {{new Date(order.billdate).getDate()+"-"+(new Date(order.billdate).getMonth()+1)+"-"+new Date(order.billdate).getFullYear()}}<br />
      ...
      <table border="1" width="100%" cellspacing="0">
        <!-- <tr>
          ...
          <td width="5%"><b>QTY</b></td>
            ...
            <tr v-for="(value, index) in Orderitems">
              ...
              <td v-if="configuration.taxes == 1" width="5%">{{value.taxprice/2}}<br />({{value.item.subType.type.tax.percentage/2}}%)  </td>
              <td v-if="configuration.taxes == 1" width="5%">{{value.taxprice/2}}<br />({{value.item.subType.type.tax.percentage/2}}%)  </td>
              <td v-if="configuration.taxes == 1" width="5%">-  </td>
              <td width="10%">{{(parseFloat(value.quantity) * parseFloat(value.itemprice) ) + parseFloat(value.taxprice)}}</td>
            </tr>
                <tr>
      ...
      <table border="1" width="100%" cellspacing="0">
        ...
        <tbody><tr>
          <td rowspan="3" width="50%">
            ...
            <li>Bank IFSC CODE: {{companyDetails.bankifsc}}</li></td>
          <td rowspan="3" width="50%" style="padding: 0px;vertical-align: bottom;">
            ...
            <table border="1" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                  <td>Sub: Discount </td>
                  <td v-if="new String(order.discount).indexOf('%') > -1">{{parseFloat(order.itemtotal * parseFloat(order.discount.toString().substr(0,order.discount.toString().length - 1)) / 100)}} ({{order.discount}})</td>
        ...
        <tr>
          <td rowspan="4">
            ...
            <li>Date of Supply: {{new Date(order.dateofsupply).getDate()+"-"+(new Date(order.dateofsupply).getMonth()+1)+"-"+new Date(order.dateofsupply).getFullYear()}}</li>
          ...
          <td rowspan="4">
            ...
            <span ref="tnc"></span>            <br /><br />
                    <center>Cetified that the particular given above are true and correct</center><center>For,</center><br /><br /><center>Authorised Signatory</center></td>
        </tr>
        <tr>
          <!-- <td ></td> -->
          <!-- <td></td> -->
